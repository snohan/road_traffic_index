...
1.	Vegkategori.
2.	Geografiske inndelinger: fylker, landsdeler.
3.	Døgninndelinger, f.eks. yrkedøgn og helgedøgn.
4.	Kjøretøylengde, f.eks. lette (L21) og tunge (L22+L23+L24+L25) kjøretøy.
...
$$Q_{f,y,s,t}^{\mathrm{i}} = \frac{1}{\sum_j Q_{j,y,s,t-1}} \sum_j Q_{j,y,s,t}^{\mathrm{i}} \,\cdot\, Q_{j,y,s,t-1} = \frac{1}{Q_{f,y,s,t-1}} \sum_j \frac{Q_{j,y,s,t}}{Q_{j,y,s,t-1}} \,\cdot\, Q_{j,y,s,t-1} = \frac{Q_{f,y,s,t}}{Q_{f,y,s,t-1}} $$
Fylkesindeks for flere måneder er basert på

$$Q_{f,y,\Sigma s, t} = \sum_{j,h,d,s} Q_{j,h,d,y,s,t}  \quad \exists \, Q_{j,h,d,y,s,t-1} \,,$$
som gir

$$Q_{f,y,\Sigma s,t}^{\mathrm{i}} = \frac{Q_{f,y,\Sigma s,t}}{Q_{f,y,\Sigma s,t-1}} \,.$$
...
##	Aggregerte indekser
Vegtrafikkindeksen på grunnivå, dvs. for hvert fylke og hver vegkategori, skal alltid være forholdet mellom de respektive trafikkvolumene. Aggregerte indekser skal alltid være et vektet gjennomsnitt av indeksen på grunnivå/lavere nivå.

Trafikkarbeidsvekter

Sammenhengen mellom fylker og landsdeler
