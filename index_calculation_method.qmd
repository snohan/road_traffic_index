...
# Forord {.unnumbered}
Dette notatet beskriver en forbedret metode for beregning av trafikkindeks. Det fokuseres her på teorien rundt beregningsmetoden til selve indeksverdien, samt usikkerheten som hører til beregningene.
...
\end{aligned}
$$ {#eq-w_indeks_3}
altså en vektet sum av trafikkmengdene $p_{bi}$ i beregningsåret $a$.
