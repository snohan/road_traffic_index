...
\end{aligned}
$${#eq-w_index_as_sum}
På denne måten kan bidraget fra hver lenke i utvalget isoleres og sammenlignes. Da lenkenes trafikkarbeid er forskjellig, vil de bidra ulikt til indeksen.
...
Indeksen kan sammenligne MDT for en gitt kalendermåned mellom to år, men vi kan benytte samme formel for å sammenlign gjennomsnittlig MDT for vilkårlige perioder. For å sammenligne siste tre år med et gitt referanseår, vil gjennomsnittlig MDT for siste 36 måneder sammenlignes med gjennomsnittlig MDT for de 12 månedene i referanseåret. 

Bortfall av måneder vil ha skjev påvirkning på et årsgjennomsnitt. Dersom eksempelvis februar mangler, men de øvrige månedene blir vektet sammen slik at summen av vektene også utelater februar, blir resultatet det samme som om februar hadde fått tilordnet en verdi lik gjennomsnittet av de øvrige månedene. Dersom det settes krav til at minst en av månedene januar og februar skal være med, slik at dersom februar mangler så vektes januar med summen av vektene til både januar og februar, så vil februar få tilordnet en verdi lik januar og feilen blir sannsynligvis mindre. For å tillate litt bortfall uten at det påvirker for skjevt, må vi ha følgende:
...
- juli
- august
- minst en av september, oktober, november
- desember

Pinsen, som utgjør en liten andel av året, kan mangle, men da skal den ikke tas med i verken sammenlignings- eller beregningsperiode for den aktuelle trafikklenken.
